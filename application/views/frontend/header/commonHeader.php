...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Fredericka+the+Great" rel="stylesheet"> -->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/frontend/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-1 col-xs-1 col-md-1 logo-style">
                        <!-- <div id="fh5co-logo"> -->
                        <a href="<?= base_url() ?>">
                            <img class="logo-image-dimension" src="<?= base_url() ?>assets/frontend/images/logo/clogo.svg" />
                            <!-- <img class="logo-image-dimension"
                                src="<?= base_url() ?>assets/frontend/images/logo/C_LOGO.png" /> -->
                        </a>
                        <!-- </div> -->
                    </div>
                    ...
                    <div class="col-sm-7 col-xs-9 col-md-7 text-center menu-1 nav-link-text">
                        <ul>
                            <li class="nav-item <?= $page == 'home' ? 'active' : '' ?>"><a href="<?= base_url() ?>" class="nav-link nav-text pl-0" style="font-size: 14px;">Home</a></li>
                            <li class="nav-item <?= $page == 'product' ? 'active' : '' ?>"><a href="<?php echo site_url('product') ?>" class="nav-link nav-text" style="font-size: 14px;">Shop</a></li>
                            <!-- <li class="nav-item <?= $page == 'makeyourown' ? 'active' : '' ?>"><a href="<?php echo site_url('make-your-own') ?>" class="nav-link nav-text" style="font-size: 14px;">Make Your Own Combo</a></li> -->
                            <!--<li class="nav-item <?= $page == 'about' ? 'active' : '' ?>"><a href="<?php echo site_url('about') ?>" class="nav-link nav-text" style="font-size: 14px;">About Us</a></li>-->
                            <!-- <li class="nav-item <?= $page == 'faq' ? 'active' : '' ?>"><a href="<?php echo site_url('faq') ?>" class="nav-link nav-text" style="font-size: 14px;">FAQ's</a></li> -->
                            <!--<li class="nav-item <?= $page == 'contact' ? 'active' : '' ?>"><a href="<?php echo site_url('contact') ?>" class="nav-link" style="font-size: 14px;">Contact Us</a></li>-->
                            <li class="nav-item shopping-cart"><a href="<?php echo site_url('cart') ?>" class="nav-link cart"><span><small><?= $this->cart->total_items() ?></small><i class="icon-shopping-cart"></i></span></a></li>
                        </ul>
                    </div>
                </div>
