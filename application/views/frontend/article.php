...
<!--       <div class="top-bar">
      ...
      <div class="site-section-cover overlay inner-page bg-light" style="background-image: url('<?=base_url()?>/assets/upload/<?=$article->file_name?>')" data-aos="fade">
          ...
          <div class="col-lg-10">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1">
                <span class="d-block mb-3 text-white" data-aos="fade-up"><?php echo $article->created_at; ?> <span class="mx-2 text-primary">&bullet;</span> by Al Tamimi</span>
                <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">Title</h1>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 blog-content">
            <p class="lead"><?php echo $article->article; ?></p>
